...
# about the baseline
We provide retrieval-based and generation-based baseline systems.The retrieval-based system is implemented by [PaddlePaddle](http://paddlepaddle.org/) (the Baidu deeplearning framework). The generation-based system is implemented by [Pytorch](https://pytorch.org/) (the Facebook deeplearning framework). The performance of the two systems is as follows:
